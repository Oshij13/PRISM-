    ...
    prepareHydratedValue(value, columnMetadata) {
        ...
        if (columnMetadata.type === Boolean ||
            ...
            try {
                ...
                console.error("[TYPEORM DEBUGLOG] Error parsing simple-json column!");
                console.error("  Entity target:", columnMetadata.entityMetadata ? columnMetadata.entityMetadata.targetName : "unknown");
                console.error("  Column databaseName:", columnMetadata.databaseName);
                console.error("  Column propertyName:", columnMetadata.propertyName);
                console.error("  Value type:", typeof value);
                console.error("  Value preview:", typeof value === 'string' ? value.substring(0, 500) : value);
